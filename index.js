...
// function computeGridTrading(bottom, top, row, perVolume) {
//         const distance = (bottom - top) / (row - 1)
//         const result = []
//         for (let index = bottom; index <= top; index += distance) {
//             result.push(index)
//         }
...
// console.log(computeGridTrading(3.9451, 4.4525, 5))
console.log('hth')
const bottom = 3.9451
const top = 4.4525
const row = 5
